\chapter{Giới thiệu}
Mục tiêu của Chương 1 là giới thiệu đề tài nghiên cứu "Xây dựng Nền tảng Social Commerce tích hợp AI". Chương cũng trình bày động lực phát triển đề tài, phạm vi và mục tiêu dự án, đồng thời giới thiệu cấu trúc tổng thể của báo cáo.
...
\item \textbf{Trải nghiệm thời gian thực:} Các tính năng như chat, thông báo đơn hàng, lịch đăng bài và phản hồi đánh giá được cập nhật theo thời gian thực thông qua Socket.io, đáp ứng kỳ vọng “luôn trực tuyến” của người dùng.
    \item \textbf{Năng suất nội dung được hỗ trợ bởi AI:} Hệ thống tích hợp Google Gemini API và Google Veo 2 để hỗ trợ tạo nội dung đa phương thức, bao gồm: tạo bài viết từ mô tả, ý tưởng và hình ảnh sản phẩm; tạo đồng thời bài viết và hình ảnh; tạo video ngắn kèm hình ảnh và bài viết. Tính năng này giúp người bán và nhà sáng tạo tiết kiệm thời gian và tạo ra nội dung chất lượng cao.
...
Nền tảng tích hợp bộ công cụ AI phục vụ cả người dùng (gợi ý sản phẩm, cửa hàng, nội dung phù hợp) và người bán (Google Gemini API và Google Veo 2 hỗ trợ sáng tạo nội dung đa phương thức, tối ưu thông điệp, đề xuất khung giờ đăng bài).
...
Chương 1: Giới thiệu
\begin{itemize}
\item Phần 1: Trình bày lý do lựa chọn đề tài "Nền tảng Social Commerce tích hợp AI".
...
\begin{itemize}
\item Phần 1: Trình bày một số nền tảng social commerce cũng như một số phần mềm quản lý thương mại điện tử hiện tại, cùng với ưu điểm và nhược điểm của chúng.
\item Phần 2: Liệt kê và mô tả các bên liên quan trong dự án.
\item Phần 3: Trình bày yêu cầu chức năng cho từng loại người dùng cụ thể và yêu cầu phi chức năng cho toàn bộ hệ thống.
\end{itemize}
...
\item Phần 7: Trình bày Deployment Diagram và giải thích cho từng lớp (layer) triển khai.
\end{itemize}

Chương 4: Nghiên cứu Công nghệ
\begin{itemize}
\item Phần 1: Trình bày và so sánh một số framework front-end, đồng thời nêu rõ framework được lựa chọn.
\item Phần 2: Trình bày và so sánh một số công nghệ back-end, đồng thời nêu rõ công nghệ được lựa chọn.
\item Phần 3: Trình bày và so sánh một số hệ quản trị cơ sở dữ liệu, đồng thời nêu rõ phần mềm được lựa chọn.
\item Phần 4: Trình bày và so sánh một số công cụ kiểm thử API và hiệu năng (performance), đồng thời nêu rõ công cụ được lựa chọn.
\end{itemize}

Chương 5: Triển khai Hệ thống
\begin{itemize}
\item Phần 1: Trình bày sơ đồ UI Flow, thiết kế UI chi tiết và giải thích các bước hoạt động chính.
\item Phần 2: Minh họa một số giao diện người dùng đã được triển khai trong hệ thống.
\end{itemize}

Chương 6: Tóm tắt và Kế hoạch Tương lai
\begin{itemize}
\item Phần 1: Tóm tắt các kết quả đã đạt được trong quá trình thực hiện dự án.
\item Phần 2: Đề xuất kế hoạch phát triển và mở rộng dự án trong giai đoạn tiếp theo.
\end{itemize}

Phụ lục: Trình bày đóng góp của từng thành viên và kế hoạch triển khai công việc chi tiết trong suốt quá trình thực hiện dự án.