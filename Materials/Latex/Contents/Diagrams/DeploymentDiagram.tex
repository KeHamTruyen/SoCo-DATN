...
Chương này mô tả cách đưa Social Commerce lên môi trường thực tế. Kiến trúc tổng thể xem Hình~\ref{fig:deployment-diagram} (chương Thiết kế hệ thống).
...
\begin{figure}[H]
\centering
% \includegraphics[width=0.92\textwidth]{Images/deploy/neon-project-connection.png}
\fbox{\begin{minipage}{0.88\textwidth}\centering\vspace{2.2cm}
\textit{[Chèn ảnh: Neon --- project / connection string / SQL editor]}\\[0.3em]
\footnotesize Đặt file tại \texttt{Images/deploy/neon-project-connection.png} rồi bỏ comment \texttt{includegraphics} ở trên.
\vspace{2.2cm}\end{minipage}}
\caption{Minh họa: tạo project Neon và sao chép chuỗi kết nối.}
\label{fig:deploy-neon}
\end{figure}
...
\begin{figure}[H]
\centering
% \includegraphics[width=0.92\textwidth]{Images/deploy/ec2-launch-instance.png}
\fbox{\begin{minipage}{0.88\textwidth}\centering\vspace{2.2cm}
\textit{[Chèn ảnh: EC2 --- Launch instance, chọn AMI / instance type]}\\[0.3em]
\footnotesize File gợi ý: \texttt{Images/deploy/ec2-launch-instance.png}
\vspace{2.2cm}\end{minipage}}
\caption{Minh họa: khởi tạo instance EC2.}
\label{fig:deploy-ec2-launch}
\end{figure}

\begin{figure}[H]
\centering
% \includegraphics[width=0.92\textwidth]{Images/deploy/ec2-security-group.png}
\fbox{\begin{minipage}{0.88\textwidth}\centering\vspace{2.2cm}
\textit{[Chèn ảnh: Security group --- cổng 22, 80, 443]}\\[0.3em]
\footnotesize File gợi ý: \texttt{Images/deploy/ec2-security-group.png}
\vspace{2.2cm}\end{minipage}}
\caption{Minh họa: nhóm bảo mật (firewall) cho EC2.}
\label{fig:deploy-ec2-sg}
\end{figure}
...
\begin{figure}[H]
\centering
% \includegraphics[width=0.92\textwidth]{Images/deploy/ec2-ssh-connect.png}
\fbox{\begin{minipage}{0.88\textwidth}\centering\vspace{2.2cm}
\textit{[Chèn ảnh: AWS Console --- Connect / lệnh SSH hoặc terminal đã kết nối]}\\[0.3em]
\footnotesize File gợi ý: \texttt{Images/deploy/ec2-ssh-connect.png}
\vspace{2.2cm}\end{minipage}}
\caption{Minh họa: kết nối SSH tới EC2.}
...
\begin{figure}[H]
\centering
% \includegraphics[width=0.92\textwidth]{Images/deploy/vercel-new-project.png}
\fbox{\begin{minipage}{0.88\textwidth}\centering\vspace{2.2cm}
\textit{[Chèn ảnh: Vercel --- Import / New Project, chọn repo]}\\[0.3em]
\footnotesize File gợi ý: \texttt{Images/deploy/vercel-new-project.png}
\vspace{2.2cm}\end{minipage}}
\caption{Minh họa: tạo project Vercel từ GitHub.}
\label{fig:deploy-vercel-new}
\end{figure}

\begin{figure}[H]
\centering
% \includegraphics[width=0.92\textwidth]{Images/deploy/vercel-build-settings.png}
\fbox{\begin{minipage}{0.88\textwidth}\centering\vspace{2.2cm}
\textit{[Chèn ảnh: Root Directory = frontend, Build / Output]}\\[0.3em]
\footnotesize File gợi ý: \texttt{Images/deploy/vercel-build-settings.png}
\vspace{2.2cm}\end{minipage}}
\caption{Minh họa: cấu hình build Vite (thư mục \texttt{frontend}, output \texttt{dist}).}
\label{fig:deploy-vercel-build}
\end{figure}
...
\begin{figure}[H]
\centering
% \includegraphics[width=0.92\textwidth]{Images/deploy/vercel-env-vars.png}
\fbox{\begin{minipage}{0.88\textwidth}\centering\vspace{2.2cm}
\textit{[Chèn ảnh: Vercel --- Environment Variables, \texttt{VITE\_API\_BASE\_URL}]}\\[0.3em]
\footnotesize File gợi ý: \texttt{Images/deploy/vercel-env-vars.png}
\vspace{2.2cm}\end{minipage}}
\caption{Minh họa: thiết lập biến môi trường trên Vercel.}
\label{fig:deploy-vercel-env}
\end{figure}

\begin{figure}[H]
\centering
% \includegraphics[width=0.92\textwidth]{Images/deploy/vercel-deploy-success.png}
\fbox{\begin{minipage}{0.88\textwidth}\centering\vspace{2.2cm}
\textit{[Chèn ảnh: Vercel --- deployment thành công / preview URL]}\\[0.3em]
\footnotesize File gợi ý: \texttt{Images/deploy/vercel-deploy-success.png}
\vspace{2.2cm}\end{minipage}}
\caption{Minh họa: kết quả triển khai frontend trên Vercel.}
\label{fig:deploy-vercel-success}
\end{figure}

%----------------------------------------------------------------------
\section{Backend quản trị và giao diện admin (tùy chọn)}
%----------------------------------------------------------------------
