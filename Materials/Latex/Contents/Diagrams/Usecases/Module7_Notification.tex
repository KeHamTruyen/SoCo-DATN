...
\textbf{Mô tả} & Hệ thống tự động gửi thông báo đến người liên quan khi có người khác thực hiện các hành động như thích bài viết, bình luận hoặc theo dõi người dùng. \\ \hline
...
\begin{itemize}
    \item A1: Người dùng B đang không online $\rightarrow$ Thông báo vẫn được lưu và sẽ hiển thị ngay khi người đó đăng nhập lại.
    \item A2: Người dùng B tắt âm thanh thông báo $\rightarrow$ chỉ hiển thị hình ảnh.
\end{itemize} \\ \hline
\textbf{Ngoại lệ} & 
\begin{itemize}
    \item E1: Chủ sở hữu nội dung không tồn tại hoặc nội dung đã bị xóa $\rightarrow$ Không gửi thông báo.
...
\textbf{Luồng thay thế} & 
\begin{itemize}
    \item A1: Một bên đang offline $\rightarrow$ Thông báo được lưu và hiển thị khi đăng nhập lại.
\end{itemize} \\ \hline
\textbf{Ngoại lệ} & 
\begin{itemize}
    \item E1: Đơn hàng bị hủy ngay lập tức bởi người mua trước khi người bán nhìn thấy $\rightarrow$ chỉ gửi thông báo hủy.
\end{itemize} \\ \hline
...
\textbf{Luồng thay thế} & 
\begin{itemize}
    \item A1: Người dùng chọn ``Xóa tất cả thông báo'' $\rightarrow$ toàn bộ thông báo bị xóa vĩnh viễn.
\end{itemize} \\ \hline
\textbf{Ngoại lệ} & 
\begin{itemize}
    \item E1: Không có thông báo nào $\rightarrow$ hiển thị dòng chữ ``Bạn chưa có thông báo nào''.
\end{itemize} \\ \hline
...
\textbf{Tác nhân} & Người dùng \\ \hline
\textbf{Mô tả} & Người dùng có thể tự quyết định sẽ nhận một số nhóm thông báo nào trên web, chẳng hạn thông báo xã hội, đơn hàng và hệ thống. \\ \hline
...
\begin{enumerate}
    ...
    \item Người dùng bật/tắt từng nhóm thông báo được hệ thống hỗ trợ.
    \item Người dùng nhấn ``Lưu cài đặt''.
    \item Hệ thống lưu và áp dụng ngay lập tức.
\end{enumerate} \\ \hline
\textbf{Luồng thay thế} & 
\begin{itemize}
    \item A1: Người dùng chọn ``Tắt tất cả thông báo'' $\rightarrow$ toàn bộ thông báo (trừ thông báo hệ thống bắt buộc) sẽ không hiển thị nữa.
\end{itemize} \\ \hline
\textbf{Ngoại lệ} & 
\begin{itemize}
    \item Không có.
