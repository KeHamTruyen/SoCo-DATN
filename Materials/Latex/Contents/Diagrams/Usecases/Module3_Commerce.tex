...
\textbf{Ngoại lệ} & 
\begin{itemize}
    \item E1: Không tìm thấy sản phẩm nào $\rightarrow$ Hệ thống hiển thị thông báo ``Không tìm thấy kết quả phù hợp''.
\end{itemize} \\ \hline
\end{tabularx}
...
\textbf{Ngoại lệ} & 
\begin{itemize}
    \item E1: Sản phẩm không còn tồn tại hoặc đã bị ẩn $\rightarrow$ Hệ thống hiển thị trang lỗi ``Sản phẩm không tìm thấy''.
\end{itemize} \\ \hline
\end{tabularx}
...
\begin{enumerate}
    ...
    \item Hệ thống lưu thông tin sản phẩm vào giỏ hàng của người mua.
    \item Hệ thống hiển thị thông báo thành công.
\end{enumerate} \\ \hline
\textbf{Ngoại lệ} & 
\begin{itemize}
    \item E1: Sản phẩm đã hết hàng $\rightarrow$ Hệ thống báo lỗi và không cho phép thêm vào giỏ.
\end{itemize} \\ \hline
\end{tabularx}
...
\textbf{Ngoại lệ} & 
\begin{itemize}
    \item E1: Cập nhật số lượng vượt quá số lượng tồn kho $\rightarrow$ Hệ thống báo lỗi.
\end{itemize} \\ \hline
\end{tabularx}
...
\textbf{Điều kiện sau} & 
\begin{itemize}
    \item Một đơn hàng mới được tạo trong hệ thống với trạng thái ``Đang xử lý''.
...
\begin{enumerate}
    ...
    \item Hệ thống tạo bản ghi đơn hàng mới.
    \item Hệ thống hiển thị thông báo đặt hàng thành công.
\end{enumerate} \\ \hline
\textbf{Ngoại lệ} & 
\begin{itemize}
    \item E1: Một sản phẩm trong giỏ đã hết hàng $\rightarrow$ Hệ thống báo lỗi và yêu cầu cập nhật giỏ hàng.
\end{itemize} \\ \hline
\end{tabularx}
...
\textbf{Luồng sự kiện chính} & 
\begin{enumerate}
    \item Người mua vào mục đơn hàng đã hoàn thành.
    ...
    \item Hệ thống lưu lại đánh giá.
\end{enumerate} \\ \hline
\textbf{Ngoại lệ} & 
\begin{itemize}
    \item E1: Người mua cố gắng đánh giá một sản phẩm họ chưa mua $\rightarrow$ Hệ thống không cho phép.
\end{itemize} \\ \hline
...
\textbf{Ngoại lệ} & 
\begin{itemize}
    \item E1: Dữ liệu nhập vào không hợp lệ (ví dụ: giá âm) $\rightarrow$ Hệ thống báo lỗi.
\end{itemize} \\ \hline
...
\begin{enumerate}
    ...
    \item Người bán vào mục ``Yêu cầu hoàn tiền'' để xem chi tiết lý do.
