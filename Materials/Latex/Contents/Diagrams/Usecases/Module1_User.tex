...
\textbf{Điều kiện sau} & 
\begin{itemize}
    \item Vai trò của người dùng được cập nhật thành Seller.
    \item Người dùng có quyền truy cập các chức năng dành cho người bán.
\end{itemize} \\ \hline
\textbf{Luồng sự kiện chính} & 
\begin{enumerate}
    ...
    \item Hệ thống yêu cầu xác minh bổ sung qua email/số điện thoại.
    \item Người dùng hoàn thành xác minh.
    \item Hệ thống cập nhật vai trò của người dùng thành Seller.
    \item Hệ thống hiển thị thông báo chúc mừng và chuyển hướng đến Bảng điều khiển bán hàng.
\end{enumerate} \\ \hline
