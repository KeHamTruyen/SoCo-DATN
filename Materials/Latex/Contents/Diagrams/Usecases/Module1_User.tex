...
\begin{itemize}
    ...
    \item Hệ thống gửi email xác thực tài khoản.
...
\begin{enumerate}
    ...
    \item Hệ thống gửi email xác thực.
...
\begin{enumerate}
    ...
    \item Người dùng lấy mã OTP từ email.
...
\begin{itemize}
    \item A1: Người dùng nhấn ``Hủy'' $\rightarrow$ Các thay đổi sẽ không được lưu.
\end{itemize} \\ \hline
\textbf{Ngoại lệ} & 
\begin{itemize}
...
\textbf{Điều kiện sau} & 
\begin{itemize}
    \item Hồ sơ đăng ký seller được lưu với trạng thái chờ duyệt.
    \item Sau khi admin duyệt, vai trò của người dùng được cập nhật thành Seller và người dùng có quyền truy cập các chức năng dành cho người bán.
\end{itemize} \\ \hline
\textbf{Luồng sự kiện chính} & 
\begin{enumerate}
    \item Người dùng truy cập trang ``Đăng ký Bán hàng''.
    \item Người dùng điền các thông tin bổ sung.
    \item Người dùng nhấn ``Đăng ký''.
    \item Hệ thống lưu hồ sơ đăng ký với trạng thái chờ duyệt.
    \item Admin xem xét hồ sơ và quyết định phê duyệt hoặc từ chối.
    \item Nếu được phê duyệt, hệ thống cập nhật vai trò của người dùng thành Seller.
    \item Hệ thống thông báo kết quả và cho phép seller truy cập Bảng điều khiển bán hàng.
\end{enumerate} \\ \hline
\textbf{Luồng thay thế} & 
\begin{itemize}
    \item A1: Người dùng hủy bỏ quá trình đăng ký.
\end{itemize} \\ \hline
\textbf{Ngoại lệ} & 
\begin{itemize}
    \item E1: Thông tin cung cấp không hợp lệ $\rightarrow$ Báo lỗi.
    \item E2: Quá trình xác minh thất bại $\rightarrow$ Báo lỗi và yêu cầu thử lại.
\end{itemize} \\ \hline
