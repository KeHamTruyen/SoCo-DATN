...
\end{enumerate} \\ \hline
\textbf{Ngoại lệ} & E1: Quản trị viên cố gắng thực hiện hành động trên tài khoản quản trị viên khác có quyền hạn cao hơn $\rightarrow$ Hệ thống từ chối. \\ \hline
...
\end{enumerate} \\ \hline
\textbf{Luồng thay thế} & A1: Quản trị viên xác định báo cáo là không hợp lệ và đánh dấu là ``Từ chối''. \\ \hline
\textbf{Ngoại lệ} & E1: Nội dung bị báo cáo đã được người dùng tự xóa trước khi admin xử lý $\rightarrow$ Admin đánh dấu báo cáo là đã giải quyết. \\ \hline
...
\end{enumerate} \\ \hline
\textbf{Ngoại lệ} & E1: Lỗi khi tổng hợp dữ liệu $\rightarrow$ Hệ thống báo lỗi. \\ \hline
