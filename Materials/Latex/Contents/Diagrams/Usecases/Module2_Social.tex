...
\textbf{Ngoại lệ} & 
\begin{itemize}
    \item E1: Lỗi tải dữ liệu $\rightarrow$ Hệ thống hiển thị thông báo lỗi và nút ``Thử lại''.
\end{itemize} \\ \hline
...
\begin{itemize}
    \item A1: Người dùng hủy bỏ việc tạo bài đăng, nội dung nháp sẽ bị xóa.
\end{itemize} \\ \hline
\textbf{Ngoại lệ} & 
\begin{itemize}
...
\end{itemize} \\ \hline
\textbf{Điều kiện sau} & Bài đăng được tạo ra có chứa liên kết trực tiếp đến các trang sản phẩm đã được gắn thẻ. \\ \hline
\textbf{Luồng sự kiện chính} & 
\begin{enumerate}
    \item Khi đang soạn bài đăng, người bán chọn chức năng ``Gắn thẻ sản phẩm''.
    \item Hệ thống hiển thị giao diện tìm kiếm và danh sách sản phẩm của người bán.
    \item Người bán chọn một hoặc nhiều sản phẩm để gắn thẻ.
    \item Người bán hoàn tất việc tạo bài đăng và nhấn ``Đăng''.
    \item Hệ thống lưu bài đăng cùng với danh sách sản phẩm được gắn thẻ.
    \item Khi hiển thị, bài đăng sẽ có các sản phẩm được gắn thẻ kèm thông tin cơ bản.
\end{enumerate} \\ \hline
\textbf{Ngoại lệ} & 
\begin{itemize}
    \item E1: Người bán cố gắng gắn thẻ một sản phẩm đã bị xóa hoặc ẩn $\rightarrow$ Hệ thống báo lỗi.
\end{itemize} \\ \hline
...
\textbf{Ngoại lệ} & 
\begin{itemize}
    \item E1: Mất kết nối mạng $\rightarrow$ Hệ thống báo lỗi, hành động không thực hiện.
\end{itemize} \\ \hline
\end{tabularx}
...
\textbf{Luồng thay thế} & 
\begin{itemize}
    \item A1: Người dùng nhấn nút ``Hủy theo dõi'' để xóa bỏ mối quan hệ.
\end{itemize} \\ \hline
\textbf{Ngoại lệ} & 
\begin{itemize}
    \item E1: Người dùng cố gắng theo dõi chính mình $\rightarrow$ Hệ thống không cho phép.
\end{itemize} \\ \hline
\end{tabularx}
...
\textbf{Luồng sự kiện chính} & 
\begin{enumerate}
    \item Người dùng A mở cửa sổ chat với người dùng B.
    \item Người dùng A nhập tin nhắn và nhấn gửi.
    \item Hệ thống (sử dụng Socket.IO) gửi tin nhắn đến người dùng B ngay lập tức.
    \item Tin nhắn hiển thị trên giao diện của cả hai người.
    \item Hệ thống lưu tin nhắn vào cơ sở dữ liệu.
\end{enumerate} \\ \hline
\textbf{Ngoại lệ} & 
\begin{itemize}
    \item E1: Cuộc trò chuyện không tồn tại hoặc người gửi không thuộc cuộc trò chuyện $\rightarrow$ Hệ thống từ chối gửi tin nhắn.
...
\textbf{Luồng thay thế} & 
\begin{itemize}
    \item A1: Người dùng rời khỏi một nhóm mà họ đã tham gia.
\end{itemize} \\ \hline
\textbf{Ngoại lệ} & 
\begin{itemize}
    \item E1: Nhóm không tồn tại, đã bị xóa hoặc người dùng không đủ quyền truy cập $\rightarrow$ Hệ thống không cho phép tham gia.
\end{itemize} \\ \hline
\end{tabularx}
...
\textbf{Ngoại lệ} & 
\begin{itemize}
    \item E1: Người dùng cố gắng báo cáo cùng một đối tượng nhiều lần trong thời gian ngắn $\rightarrow$ Hệ thống hạn chế để tránh spam.
\end{itemize} \\ \hline
