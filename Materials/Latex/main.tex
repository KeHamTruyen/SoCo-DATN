...
\fancyhf{}
\fancyhead[L]{%
  \raisebox{-0.3cm}{\includegraphics[width=8mm,height=8mm]{Images/hcmut.png}}\hspace{4mm}
  \begin{tabular}{l}
...
{\fontsize{16}{19}\selectfont\bfseries ĐỒ ÁN CHUYÊN NGÀNH}\\[12mm]
% Tên đề tài
\begin{minipage}{0.92\textwidth}
\centering\fontsize{14}{17}\selectfont\bfseries
XÂY DỰNG HỆ THỐNG SOCIAL COMMERCE TÍCH HỢP AI \\[2mm]
CHO TẠO NỘI DUNG, BÁN HÀNG VÀ CHĂM SÓC KHÁCH
\end{minipage}\\[10mm]
...
\fontsize{12}{14}\selectfont HỘI ĐỒNG: & \fontsize{12}{14}\selectfont Hội đồng 7L Đồ án chuyên ngành \\[5mm]
\fontsize{12}{14}\selectfont GVHD: & \fontsize{12}{14}\selectfont Mr. Mai Duc Trung, MSc \\[5mm]
                          & \fontsize{12}{14}\selectfont CN. Nguyễn Minh Tâm \\
                          & \fontsize{13}{15}\selectfont ---o0o--- \\[6mm]
...
\end{tabular}\\[12mm]
% Năm
{\fontsize{12}{14}\selectfont TP. HỒ CHÍ MINH, THÁNG 12 NĂM 2025}
\end{center}
\end{titlepage}
%===================================================================================
\clearpage
...
\clearpage
\input{Contents/2_RequirementElicitation}
\clearpage
\input{Contents/3_SystemDesign}
\clearpage
\input{Contents/4_TechnologyResearch}
\clearpage
\input{Contents/5_SystemImplementation}
\clearpage
\input{Contents/6_SummaryAndFuturePlan}
\clearpage
\input{Outro/References}
\clearpage
\input{Outro/Appendix}
\end{document}