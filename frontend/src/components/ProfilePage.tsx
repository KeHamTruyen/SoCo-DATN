...
export function ProfilePage({ currentUser, onNavigate, onLogout }: ProfilePageProps) {
  const userProducts = mockProducts.filter(p => p.sellerId === currentUser.id);
          ...
          <div className="flex flex-col md:flex-row md:items-start gap-6">
            ...
            <div className="flex-1">
              ...
              <div className="flex gap-6 mb-4">
                <div>
                  <span className="text-lg">{currentUser.followers}</span>
                  <span className="text-gray-500 ml-1">Người theo dõi</span>
                </div>
                <div>
                  <span className="text-lg">{currentUser.following}</span>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-lg">
                  {currentUser.role === 'seller' ? 'Người bán đã xác thực' : 'Người mua'}
                </h3>
