...
export function StorePage() {
    ...
    const [activeTab, setActiveTab] = useState<"products" | "about">(
        "products",
    );
    ...
    const storeOwner = isOwnStore
        ? {
              ...
              bio:
                  currentUser.bio ||
                  "Chuyên cung cấp các sản phẩm thời trang chất lượng cao, uy tín. Cam kết hàng chính hãng 100%",
    ...
    const stats = [
        ...
        { label: "Đánh giá", value: "4.8", icon: Star },
        {
            ...
            value: storeOwner.followers.toLocaleString(),
            icon: Users,
        },
    ];
